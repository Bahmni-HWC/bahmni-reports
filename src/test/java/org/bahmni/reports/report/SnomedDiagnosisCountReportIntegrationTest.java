...
public class SnomedDiagnosisCountReportIntegrationTest extends BaseIntegrationTest {

    public SnomedDiagnosisCountReportIntegrationTest() {
        super("src/test/resources/config/snomedDiagnosisCountReportConfig.json");
    }

    @Before
    public void setUp() throws Exception {
        executeDataSet("datasets/snomedDiagnosisCountReportDataSet.xml");
    }

    @Test
    public void testSnomed() throws Exception {
        String reportName = "Diagnosis Count Report for Malaria";
